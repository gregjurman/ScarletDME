...
bool bt_get_string(DESCRIPTOR *descr,
                   /* Item to get (may not be a string, will not convert) */
...
Private void bt_not_a_btree() { k_error("Not a BTree"); }

Private void bt_key_count() { k_error("Incorrect number of BTree keys"); }
