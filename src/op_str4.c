...
void op_count() { count(FALSE); }

/* ======================================================================
   op_dcount()  -  Count delimited string fields                          */

void op_dcount() { count(TRUE); }
...
void op_matches() { matches(FALSE); }

/* ======================================================================
   op_matchfld()  -  MATCHFIELD() function                                */

void op_matchfld() { matches(TRUE); }
...
bool match_template(char *string, char *template_string, short int component,
