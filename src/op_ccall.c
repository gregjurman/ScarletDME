 ...
 *            x02 - bin 4 lib handle - binary 2 len - Function Name - Get
 * function address
 ...
 *            x12 - bin4 str2 offset - pop 32-bit result to relative location in
 * str2
 *            x13 - bin4 str2 offset - pop 64-bit result to relative location in
 * str2
 *
 *            --- others as needed
 *
