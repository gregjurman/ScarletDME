...
void dump_sysseg(bool dump_cfg) {
  ...
  for (i = 0, p = sem_tags,
      semptr =
           ((SEMAPHORE_ENTRY *)(((char *)sysseg) + sysseg->semaphore_table));
  ...
  */
  ...
  printf("Fno Ref FLk  Fvar RLk      Mod MinMod ModVal     FlkTxn       Load "
         "Inh FreeOflw\n");
  ...
  for (i = 1; i <= sysseg->used_files; i++) {
    ...
    if (fptr->ref_ct != 0) {
      ...
      FreeOflw
      123  12 123 12345 123 12345678 123456 12345678 12345678 1234567890 123
      1234ABCD
      */
  ...
  for (i = 1; i <= sysseg->numlocks; i++) {
    ...
    if ((rlptr->hash != 0) || (rlptr->count != 0)) {
      ...
      1234 123 1234 1234 123 123456 RU 1234ABCD
