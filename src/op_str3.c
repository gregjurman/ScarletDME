...
Private char* opname_strings[] = { "CAT", "LT", "GT", "EQ", "NE", "LE", "GE",
                                   "AND", "OR", "MATCH", "MATCHES" };
Private short int opname_codes[] = { TKN_COLON, TKN_LTX, TKN_GTX, TKN_EQ,
                                     TKN_NE, TKN_LE, TKN_GEX, TKN_AND, TKN_OR,
