...
void op_insert() { insert(FALSE); }

void op_compinsrt() { insert(TRUE); }
...
void op_rep() { rep(FALSE); }

void op_comprep() { rep(TRUE); }
...
void op_replace() { replace(FALSE); }

void op_compreplc() { replace(TRUE); }
...
Private void rdi(DESCRIPTOR *src_descr,    /* Source string */
                 long int field, long int value, long int subvalue,
                 short int mode, DESCRIPTOR *new_descr,
                 /* Replacement / insertion string */
