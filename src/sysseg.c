...
Private bool create_shared_segment(long int bytes, struct CONFIG *cfg,
                                   char *errmsg);

/* ====================================================================== */

bool bind_sysseg(create, errmsg) bool create;
...
Private bool create_shared_segment(bytes, cfg, errmsg) long int bytes;
struct CONFIG *cfg;
char *errmsg;
{
...
void unbind_sysseg() { shmdt((void *)sysseg); }
