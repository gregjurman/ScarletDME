...
short int month_offsets[12] = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273,
                                304, 334 };
short int days_in_month[12] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30,
                                31 };
...
#endif
        {
      for (n = sizeof(double), q = s,
          r = ((char *)&(descr->data.float_value)) + n;
           n--;) {
        *(q++) = *(--r);
      }
    } else {
