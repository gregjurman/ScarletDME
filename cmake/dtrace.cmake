...
IF(ENABLE_DTRACE)
  CONFIGURE_FILE(${CMAKE_SOURCE_DIR}/include/probes_qm.d
    ${CMAKE_BINARY_DIR}/include/probes_qm.d COPYONLY)
  DTRACE_HEADER(
   ${CMAKE_BINARY_DIR}/include/probes_qm.d
   ${CMAKE_BINARY_DIR}/include/probes_qm_dtrace.h
   ${CMAKE_BINARY_DIR}/include/probes_qm_nodtrace.h
  )
...
FUNCTION(DTRACE_INSTRUMENT target)
  ...
  IF(ENABLE_DTRACE)
    ...
    IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
      ...
      ADD_CUSTOM_COMMAND(
        ...
        COMMAND ${CMAKE_COMMAND}
          -DDTRACE=${DTRACE}
          -DOUTFILE=${outfile}
          -DDFILE=${CMAKE_BINARY_DIR}/include/probes_qm.d
    ...
    ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Linux")
      ...
      # Systemtap object and header
      EXECUTE_PROCESS(
        COMMAND ${DTRACE} -G -s ${CMAKE_SOURCE_DIR}/include/probes_qm.d
        -o ${outfile}
        )
