...
int net_lock(/* Returns 1000+blocking user if blocked */
             FILE_VAR *fvar, char *id, short int id_len, bool update,
             bool no_wait) {
  short int flags;
  struct {
    short int fno;
...
int net_read(FILE_VAR *fvar, char *id, short int id_len,
             unsigned short int op_flags, STRING_CHUNK **str) {
  short int mode;
  long int rec_len = 0;
  struct {
    short int fno;
...
int net_readv(FILE_VAR *fvar, char *id, short int id_len, int field_no,
              unsigned short int op_flags, STRING_CHUNK **str) {
  long int rec_len = 0;
  short int flags;
  struct {
...
int net_select(FILE_VAR *fvar, STRING_CHUNK **str, long int *count) {
  struct {
    short int fno;
  } ALIGN2 packet;
  int len;
...
int net_selectindexv(FILE_VAR *fvar, char *index_name, char *value,
                     STRING_CHUNK **str) {
  int len;
  long int count;
  char *p;
...
int net_write(FILE_VAR *fvar, char *id, short int id_len, STRING_CHUNK *str,
              bool keep_lock) {
  short int mode;
  long int data_len;
  int bytes;
