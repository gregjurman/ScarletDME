    ...
    switch (justification) {
      case 'C':
        ...
        if (s_len > field_width) {
          insert_text_breaks(p, &s_len, (short int) field_width, fill_char,
                             FALSE);
        }
        break;
...
rescan:
  switch (src_descr->type) {
    ...
    case STRING:
      //0227      if (src_descr->data.str.saddr == NULL) goto
...
Private void insert_commas(char *s, char thousands, /* Delimiter to insert */
